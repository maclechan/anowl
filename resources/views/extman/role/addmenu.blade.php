...
<div class="modal inmodal fade" id="addmenu" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ url('/role/addmenu') }}" method="post" id="addmenu-form" class="form-horizontal">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-lg-4 control-label">父级菜单 *</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control"  value="{{ old('mod_name') }}" name="mod_name" id="mod_name" required placeholder="如：商品管理" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="{{ old('action_name') }}" name="action_name" id="action_name" placeholder="如： index" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-4 control-label">URI路由</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="{{ old('url') }}" name="url" id="url" placeholder="如： /role/index" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-4 control-label">icon图标</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="{{ old('icon_class') }}" name="icon_class" id="icon_class" placeholder="参考fontawesome5" />
                        </div>
                    </div>
                    <div class="form-group">
