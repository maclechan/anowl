...
<div class="modal inmodal fade" id="addgroup" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ url('/role/addgroup') }}" method="post" id="addform" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea type="text" class="form-control" rows="3" value="{{ old('role_description') }}" name="role_description" required id="role_description" placeholder="如：技术部"></textarea>
                        </div>
                    </div>
                </div>
...
<div class="modal inmodal fade" id="addrole" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ url('/role/addgroup') }}" method="post" id="roleform" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea type="text" class="form-control" rows="3" value="{{ old('role_description') }}" required name="role_description" id="role_description" placeholder="如：技术组下面有前端/UI等角色"></textarea>
                        </div>
                    </div>
                </div>
