...
<div class="modal inmodal fade" id="editgroup" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ url('/role/editgroup') }}" method="post" class="form-horizontal">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea type="text" class="form-control" rows="3" value="{{ old('role_description') }}" required name="role_description" id="group_description" placeholder="如：技术组下面有前端/UI等角色"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ url('/role/editgroup') }}" method="post" class="form-horizontal">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea type="text" class="form-control" rows="3" value="{{ old('role_description') }}" name="role_description" required id="role_description" placeholder="如：技术组下面有前端/UI等角色"></textarea>
                        </div>
                    </div>
                </div>
